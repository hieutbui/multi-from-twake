...
class GetItInitializer {
  ...
  void bindingDatasource() {
    ...
    getIt.registerFactory<HiveUserRelationDatasource>(
      () => HiveUserRelationDatasourceImpl(),
    );
  ...
  void bindingRepositories() {
    ...
    getIt.registerFactory<HiveUserRelationRepository>(
      () => HiveUserRelationRepositoryImpl(),
    );
  ...
  void bindingInteractor() {
    ...
    getIt.registerFactory<SigninInteractor>(
      () => SigninInteractor(),
    );
    getIt.registerFactory<SignupInteractor>(
      () => SignupInteractor(),
    );
