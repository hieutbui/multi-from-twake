...
class TomBootstrapDialogState extends State<TomBootstrapDialog>
  ...
  void _initData() async {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      // Skip recovery word checks and proceed directly
      ...
      // Create bootstrap without recovery words
      _createBootstrap();

      // Set state to initial and close dialog quickly
      setState(() {
        _uploadRecoveryKeyState = UploadRecoveryKeyState.initial;
      });

      // Close the dialog after a short delay to allow login to proceed
      Future.delayed(
  ...
  // Commented out recovery words functionality as server no longer supports it
